...
SRC_DIR := .
BUILD_ROOT_DIR := 
PRJ_ROOT_DIR := C:/windriver/workspace/KBot2010
...
DEP_FILES := $(OBJ_DIR)/Target.d $(OBJ_DIR)/Pickup.d $(OBJ_DIR)/Shooter.d \
	 $(OBJ_DIR)/KBot.d $(OBJ_DIR)/Macros.d
-include $(DEP_FILES)

ifeq ($(BUILD_SPEC),PPC32diab)
SUBDIRS :=
OBJECTS := $(OBJ_DIR)/Target.o $(OBJ_DIR)/Pickup.o $(OBJ_DIR)/Shooter.o \
	 $(OBJ_DIR)/KBot.o $(OBJ_DIR)/Macros.o

PROJECT_TARGETS := $(OBJ_DIR)/KBot.out
...
ifeq ($(BUILD_SPEC),PPC603gnu)
SUBDIRS := "C:/windriver/workspace/KBot2010/controller" \
	 "C:/windriver/workspace/KBot2010/hardware" \
	 "C:/windriver/workspace/KBot2010/strategy"
OBJECTS := $(OBJ_DIR)/Target.o $(OBJ_DIR)/Pickup.o $(OBJ_DIR)/Shooter.o \
	 $(OBJ_DIR)/KBot.o $(OBJ_DIR)/Macros.o

PROJECT_TARGETS := $(OBJ_DIR)/KBot.out

SUB_OBJECTS := controller/$(OBJ_DIR)/CameraController.o \
	 controller/$(OBJ_DIR)/KbotPID.o \
	 controller/$(OBJ_DIR)/RobotController.o \
	 controller/$(OBJ_DIR)/RobotManager.o \
	 controller/$(OBJ_DIR)/KbotVPID.o \
	 hardware/$(OBJ_DIR)/CurrentSensor.o \
	 hardware/$(OBJ_DIR)/KbotRobotDrive.o \
	 hardware/$(OBJ_DIR)/Launcher.o \
	 hardware/$(OBJ_DIR)/Hopper.o \
	 hardware/$(OBJ_DIR)/Camera.o \
	 strategy/$(OBJ_DIR)/StrategyGoStraight.o \
	 strategy/$(OBJ_DIR)/StrategyGoAlongEdge.o \
	 strategy/$(OBJ_DIR)/StrategyTurn45.o \
	 strategy/$(OBJ_DIR)/StrategyCurveLeft.o \
	 strategy/$(OBJ_DIR)/StrategyTrack.o \
	 strategy/$(OBJ_DIR)/StrategyWeave.o \
	 strategy/$(OBJ_DIR)/StrategyLoadBalls.o \
	 strategy/$(OBJ_DIR)/StrategyCurveRight.o \
	 strategy/$(OBJ_DIR)/StrategyCircle.o \
	 strategy/$(OBJ_DIR)/StrategyAttack.o \
	 strategy/$(OBJ_DIR)/StrategyGoAlongEnd.o \
	 strategy/$(OBJ_DIR)/StrategyBackUp.o \
	 strategy/$(OBJ_DIR)/StrategyInactive.o \
	 strategy/$(OBJ_DIR)/StrategyTurn90.o \
	 strategy/$(OBJ_DIR)/Strategy.o \
	 strategy/$(OBJ_DIR)/StrategySCurve.o \
	 strategy/$(OBJ_DIR)/StrategySpin.o
SUB_TARGETS :=
endif
ifeq ($(BUILD_SPEC),PPC604diab)
SUBDIRS :=
...
IDE_INCLUDES = -IC:/windriver/workspace/KBot2010/controller -IC:/windriver/workspace/KBot2010/hardware -IC:/windriver/workspace/KBot2010/strategy -IC:/windriver/workspace/KBot2010 -I$(WIND_BASE)/target/h -I$(WIND_BASE)/target/h/WPILib -I$(WIND_BASE)/target/h/WPILib/Vision2009 -I$(WIND_BASE)/target/h/wrn/coreip 
...
DEBUGFLAGS_KBot = -XO -Xsize-opt
endif
$(OBJ_DIR)/KBot.out : $(OBJECTS) $(SUB_OBJECTS) $(SUB_TARGETS)
	$(TRACE_FLAG)echo "building $@";rm -f "$@";ddump -Ng $(OBJECTS) $(SUB_OBJECTS) $(SUB_TARGETS) $(IDE_LIBRARIES) | tclsh $(WIND_BASE)/host/resource/hutils/tcl/munch.tcl -c ppc > $(OBJ_DIR)/ctdt.c; $(TOOL_PATH)dcc $(DEBUGFLAGS_KBot) $(CC_ARCH_SPEC) -Xdollar-in-ident -Xforce-declarations $(ADDED_CFLAGS) $(IDE_INCLUDES) $(ADDED_INCLUDES) -DCPU=$(CPU) -DTOOL_FAMILY=$(TOOL_FAMILY) -DTOOL=$(TOOL) -D_WRS_KERNEL   $(DEFINES)  -o $(OBJ_DIR)/ctdt.o -c $(OBJ_DIR)/ctdt.c; $(TOOL_PATH)dld -tPPCFH:vxworks63 -X -r5 -r4 -o "$@" $(OBJ_DIR)/ctdt.o $(OBJECTS) $(SUB_OBJECTS) $(SUB_TARGETS) $(IDE_LIBRARIES) $(LIBPATH) $(LIBS)  $(ADDED_LIBPATH) $(ADDED_LIBS) && if [ "$(EXPAND_DBG)" = "1" ]; then plink "$@";fi

target_KBot : subdirs_all check_objectdir $(OBJ_DIR)/KBot.out
endif
ifeq ($(BUILD_SPEC),PPC32gnu)
ifeq ($(DEBUG_MODE),1)
DEBUGFLAGS_KBot = -g
else
DEBUGFLAGS_KBot = -O2 -fstrength-reduce -fno-builtin
endif
$(OBJ_DIR)/KBot.out : $(OBJECTS) $(SUB_OBJECTS) $(SUB_TARGETS)
	$(TRACE_FLAG)echo "building $@";rm -f "$@";nmppc $(OBJECTS) $(SUB_OBJECTS) $(SUB_TARGETS) $(IDE_LIBRARIES) | tclsh $(WIND_BASE)/host/resource/hutils/tcl/munch.tcl -c ppc > $(OBJ_DIR)/ctdt.c; $(TOOL_PATH)ccppc $(DEBUGFLAGS_KBot) $(CC_ARCH_SPEC) -fdollars-in-identifiers -Wall $(ADDED_CFLAGS) $(IDE_INCLUDES) $(ADDED_INCLUDES) -DCPU=$(CPU) -DTOOL_FAMILY=$(TOOL_FAMILY) -DTOOL=$(TOOL) -D_WRS_KERNEL   $(DEFINES)  -o $(OBJ_DIR)/ctdt.o -c $(OBJ_DIR)/ctdt.c; $(TOOL_PATH)ccppc -r -nostdlib -Wl,-X -T $(WIND_BASE)/target/h/tool/gnu/ldscripts/link.OUT -o "$@" $(OBJ_DIR)/ctdt.o $(OBJECTS) $(SUB_OBJECTS) $(SUB_TARGETS) $(IDE_LIBRARIES) $(LIBPATH) $(LIBS)  $(ADDED_LIBPATH) $(ADDED_LIBS) && if [ "$(EXPAND_DBG)" = "1" ]; then plink "$@";fi
...
DEBUGFLAGS_KBot = -O2 -nostdlib -fno-builtin -fno-defer-pop
endif
$(OBJ_DIR)/KBot.out : $(OBJECTS) $(SUB_OBJECTS) $(SUB_TARGETS)
	$(TRACE_FLAG)echo "building $@";rm -f "$@";nmpentium $(OBJECTS) $(SUB_OBJECTS) $(SUB_TARGETS) $(IDE_LIBRARIES) | tclsh $(WIND_BASE)/host/resource/hutils/tcl/munch.tcl -c pentium > $(OBJ_DIR)/ctdt.c; $(TOOL_PATH)ccpentium $(DEBUGFLAGS_KBot) $(CC_ARCH_SPEC) -fdollars-in-identifiers -Wall $(ADDED_CFLAGS) $(IDE_INCLUDES) $(ADDED_INCLUDES) -DCPU=$(CPU) -DTOOL_FAMILY=$(TOOL_FAMILY) -DTOOL=$(TOOL) -D_WRS_KERNEL   $(DEFINES)  -o $(OBJ_DIR)/ctdt.o -c $(OBJ_DIR)/ctdt.c; $(TOOL_PATH)ccpentium -r -nostdlib -Wl,-X -T $(WIND_BASE)/target/h/tool/gnu/ldscripts/link.OUT -o "$@" $(OBJ_DIR)/ctdt.o $(OBJECTS) $(SUB_OBJECTS) $(SUB_TARGETS) $(IDE_LIBRARIES) $(LIBPATH) $(LIBS)  $(ADDED_LIBPATH) $(ADDED_LIBS) && if [ "$(EXPAND_DBG)" = "1" ]; then plink "$@";fi
...
$(OBJ_DIR)/KBot.out : $(OBJECTS) $(SUB_OBJECTS) $(SUB_TARGETS)
	$(TRACE_FLAG)echo "building $@";rm -f "$@";ddump -Ng $(OBJECTS) $(SUB_OBJECTS) $(SUB_TARGETS) $(IDE_LIBRARIES) | tclsh $(WIND_BASE)/host/resource/hutils/tcl/munch.tcl -c sparc > $(OBJ_DIR)/ctdt.c; $(TOOL_PATH)dcc $(DEBUGFLAGS_KBot) $(CC_ARCH_SPEC) -Xdollar-in-ident -Xforce-declarations $(ADDED_CFLAGS) $(IDE_INCLUDES) $(ADDED_INCLUDES) -DCPU=$(CPU) -DTOOL_FAMILY=$(TOOL_FAMILY) -DTOOL=$(TOOL) -D_WRS_KERNEL   $(DEFINES)  -o $(OBJ_DIR)/ctdt.o -c $(OBJ_DIR)/ctdt.c; $(TOOL_PATH)dld -tSPARCFH:vxworks63 -X -r5 -r4 -o "$@" $(OBJ_DIR)/ctdt.o $(OBJECTS) $(SUB_OBJECTS) $(SUB_TARGETS) $(IDE_LIBRARIES) $(LIBPATH) $(LIBS)  $(ADDED_LIBPATH) $(ADDED_LIBS) && if [ "$(EXPAND_DBG)" = "1" ]; then plink "$@";fi
